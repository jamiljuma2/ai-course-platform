        ...
        <div className="grid sm:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-lg bg-brand-500 flex items-center justify-center text-sm font-bold text-white shadow-md shadow-brand-500/25">AI</div>
          ...
          <div>
            <h4 className="text-dark-900 font-semibold mb-4">Course</h4>
            <ul className="space-y-2 text-dark-600 text-sm">
              ...
              <li><a href="#pricing" className="hover:text-brand-700 transition-colors">Pricing</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-dark-600 text-sm">
              <li><a href={`mailto:${process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'support@aicourse.co.ke'}`} className="hover:text-brand-700 transition-colors">Email Support</a></li>
              <li><a href="#" className="hover:text-brand-700 transition-colors">FAQ</a></li>
              <li><a href="#" className="hover:text-brand-700 transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-brand-700 transition-colors">Terms of Service</a></li>
            </ul>
          </div>
        </div>
